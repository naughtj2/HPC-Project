...
namespace pricer {
    ...
    /** @brief Compute d2. */
    double BSAnalytic::d2(double S, double K, double r, double q, double sigma, double T) {
        return d1(S,K,r,q,sigma,T) - sigma * std::sqrt(T);
    }
    /** @brief Closed-form European call price. */
    ...
    /** @brief Closed-form European put price. */
    ...
    /** @brief Vega for a European option. */
